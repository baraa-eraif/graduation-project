...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        <!--begin::Aside-->
        <div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-color: #93f5f8">
            <!--begin::Wrapper-->
        ...
        <div class="d-flex flex-column flex-lg-row-fluid py-10">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid">
                ...
                <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form method="post" class="form w-100" id="kt_sign_in_form" action="{{route('teacher.login')}}">
                        @csrf
                        @method('post')
                        <!--begin::Heading-->
                        <div class="text-center mb-10">
                            <!--begin::Title-->
                            <h1 class="text-dark mb-3">بوابة المدرس</h1>
                            <!--end::Title-->
                            <!--begin::Link-->
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="form-label fs-6 fw-bolder text-dark">معرف المدرس</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input class="form-control form-control-lg form-control-solid" type="number" name="teacher_id" autocomplete="off" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
