        ...
        <div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative"
            ...
            <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                ...
                <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                    ...
                    <!--end::Logo-->
                    <!--begin::Title-->
                    <h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #986923;">بوابة الإدارة</h1>
                    <!--end::Title-->
                    <!--begin::Description-->
        ...
        <div class="d-flex flex-column flex-lg-row-fluid py-10">
            ...
            <div class="d-flex flex-center flex-column flex-column-fluid">
                ...
                <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                    <!--begin::Form-->
                    <form method="post" class="form w-100" id="kt_sign_in_form" action="{{route('admin.login')}}">
                        @csrf
                        @method('post')
                        <!--begin::Heading-->
                        <div class="text-center mb-10">
                            <!--begin::Title-->
                            <h1 class="text-dark mb-3">بوابة الإدارة</h1>
                            <!--end::Title-->
                            <!--begin::Link-->
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="form-label fs-6 fw-bolder text-dark">معرف الإدارة</label>
                            <!--end::Label-->
                            <!--begin::Input-->
